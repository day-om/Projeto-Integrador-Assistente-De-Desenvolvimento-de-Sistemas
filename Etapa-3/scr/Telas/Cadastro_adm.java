...
public class Cadastro_adm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel3.add(bt_novoCadastro, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 60, 300, 30));
        ...
        jPanel3.add(bt_consultarCadastro, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 130, 300, 30));

        jPanel1.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 100, 400, 240));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Cadastro_adm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Cadastro_adm().setVisible(true);
            }
        });
    }
