...
public class lista_professor extends javax.swing.JFrame {
    ...
    public lista_professor() {
     ...
     private void iniciartabela(){
        tabela = new DefaultTableModel(new Object[]{"Aluno", "Instrumento", "Horários(manhã)", "Horários(tarde)"},0);
    ...
    private void initComponents() {
        ...
        jPanel3.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 590, 310));

        jPanel1.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 100, 590, 310));
        ...
        jPanel1.add(bt_perfil, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 10, 30, 30));
