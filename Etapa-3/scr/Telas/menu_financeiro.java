...
public class menu_financeiro extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        bt_entrada.setBackground(new java.awt.Color(51, 140, 233));
        bt_entrada.setFont(new java.awt.Font("Segoe UI", 1, 10)); // NOI18N
        bt_entrada.setForeground(new java.awt.Color(255, 255, 255));
        bt_entrada.setText("ENTRADA");
        bt_entrada.setToolTipText("Clique para cadastrar entradas");
        bt_entrada.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                bt_entradaActionPerformed(evt);
            }
        });
        jPanel1.add(bt_entrada, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 260, 160, 40));

        bt_saida.setBackground(new java.awt.Color(51, 140, 233));
        bt_saida.setFont(new java.awt.Font("Segoe UI", 1, 10)); // NOI18N
        bt_saida.setForeground(new java.awt.Color(255, 255, 255));
        bt_saida.setText("SAÍDA");
        bt_saida.setToolTipText("Clique para cadastrar saídas");
        bt_saida.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                bt_saidaActionPerformed(evt);
            }
        });
        jPanel1.add(bt_saida, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 300, 160, 40));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(menu_financeiro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new menu_financeiro().setVisible(true);
            }
        });
    }
